	...
	function ( $ ) {
		...
		addImgLink.on(
			...
			function ( event ) {
				...
				frame.on(
					'select',
					function () {
						var imgContainer = self.parents( '.pragyan-ui-field' ).find( '.mnp-upload-img' ),
						    input        = self.parents( '.pragyan-ui-field' ).find( '.mnp-upload-input' ),
		...
		delImgLink.on(
			...
			function ( event ) {
				...
				var imgContainer = $( this ).parents( '.pragyan-ui-field' ).find( '.mnp-upload-img' ),
				    input        = $( this ).parents( '.pragyan-ui-field' ).find( '.mnp-upload-input' ),
				    delLink      = $( this ),
		 ...
		 */
		( function () {
			var optionsEnabler = $( '#pragyan-menu-item-style input[type="radio"][name="pragyan_primary_menu_item_style"]' );
			...
			$( '#pragyan-menu-item-style input[type="radio"][name="pragyan_primary_menu_item_style"]:checked' ).click();
